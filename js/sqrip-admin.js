jQuery(document).ready(function ($) {
    ...
    function sqrip_toggle_dependent_settings() {
        ...
        // The country list is handled by sqrip_toggle_country_field() instead, which also
        // checks the active tab. Toggling it here as well showed the row on every other
        // tab, because .toggle(true) does not care which tab sqrip_tab_init() just drew.
